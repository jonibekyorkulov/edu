    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(blank=True, choices=[('admin', 'ADMIN'), ('teacher', 'TEACHER'), ('student', 'STUDENT')], null=True)),
                ...
                ('gender', models.CharField(blank=True, choices=[('erkak', 'ERKAK'), ('ayol', 'AYOL')], null=True)),
